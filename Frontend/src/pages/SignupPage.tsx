...
import { signup, type ISignupRequest } from '../services/authService';
...
const SignupPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('User successfully registered. Redirecting to 2FA Setup.');
            navigate('/2fa-setup'); 
            
        } catch (err: any) {
            setError(err.message || 'Registration failed due to an unexpected server error.');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-md">
                ...
                <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden p-8">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 text-center text-sm">Join our community and get started today</p>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        <p className="text-center text-gray-600 text-sm">
                            ...
                            <Link to="/login" className="ml-2 font-semibold text-yellow-600 hover:text-yellow-700 hover:underline transition-colors duration-200">
                                Log in here
                            </Link>
                        </p>
                    </div>
